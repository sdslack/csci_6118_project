...
- for categorical fields, filters can only be taken as a list of comma separated individual names
    - ex. "col=banana,red,blue"
- code can take multiple categorical and numerical varibles comma separated but need to have spaces between each different variable 
"""
        ...
        # Numerical variable filter 
            ...
            for value in values:
                if '<' in value:
                    ...
                    filtered_data = filtered_data[filtered_data[key] == float(value)]
