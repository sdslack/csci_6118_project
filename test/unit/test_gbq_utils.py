...
class TestSdsUtils(unittest.TestCase):
    ...
    def test_get_gbq_data_query1(self):
        ...
        # Number of columns should be total unique in query + get_gbq_data_params
    ...
    def test_get_gqb_data_dne(self):
        ...
        query = "Days from Infection:=-1; DNE_col1:=80; DNE_col2:=red; DNE_col3:<100"
        self.assertRaises(SystemExit, gbq_utils.get_gbq_data, query, 'SE id(SA)')
